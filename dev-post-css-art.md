---
title: Monsoon Rasam Window - CSS Art for DEV Frontend Challenge
published: false
description: A pure HTML and CSS comfort-food scene inspired by rasam rice on a rainy evening.
tags: devchallenge, frontendchallenge, css, javascript
cover_image: https://rohithmatham12.github.io/dev-comfort-food-challenge/css-art/assets/monsoon-rasam-desktop.png
---
...
{% embed https://rohithmatham12.github.io/dev-comfort-food-challenge/css-art/ %}

Source code: [GitHub repository](https://github.com/Rohithmatham12/dev-comfort-food-challenge/tree/main/css-art)

## Screenshots

Desktop:

![Monsoon Rasam Window desktop screenshot](https://rohithmatham12.github.io/dev-comfort-food-challenge/css-art/assets/monsoon-rasam-desktop.png)

Mobile:

![Monsoon Rasam Window mobile screenshot](https://rohithmatham12.github.io/dev-comfort-food-challenge/css-art/assets/monsoon-rasam-mobile.png)
...
- table details including a faint kolam pattern and banana leaf veins
- CSS-only steam, rasam shimmer, rain, droplet, lamp glow, and window puddle
  animations
